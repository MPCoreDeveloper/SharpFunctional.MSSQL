...
namespace SharpFunctional.MsSql.Functional;

/// <summary>
/// Represents the result of an operation — either a success value or an <see cref="Functional.Error"/>.
/// This is a lightweight, zero-dependency alternative to <c>LanguageExt.Fin&lt;T&gt;</c>.
/// </summary>
...
public readonly struct Fin<T> : IEquatable<Fin<T>>
{
    ...
    /// <summary>
    /// Implicit conversion from an <see cref="Functional.Error"/> to a failure result.
    /// </summary>
